 ...
 <body>
   <header>
    ...
    <div class="titre_page">
     <font size="6" color="white">Gestion du stock </font>
    </div>
   ...
   <div class="main">
    <div class="formulaire">
      <?php
        ...
        $requete="update ".$appareil." set quantite=quantite".$nb." where marque='".$marque."' and modele='".$modele."' and etat='".$etat."'";
      ...
      ?>
        <div class="reponse">
         <p>Modification réalisée avec succés</p>

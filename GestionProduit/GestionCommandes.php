   ...
   <div class="main">
    ...
    <?php
        ...
        if(!isset($_POST['changement'])){
         $requete="select * from commandespecial where identifiantCom=".$_POST['id'];
    ...
    ?>
         <table>
          ...
          <form method="post" action="GestionCommandes.php?<?php echo session_id();?>">
           ...
           <select name="etat" required>
            ...
            <option value="Arivée">Arrivée</option>
           </select>
    ...
    <?php
          ...
          $requete="update commandespecial set etat='".$_POST['etat']."' where identifiantCom=".$_POST['id'];
          $resultat=$connexion->query($requete);
          if(!$resultat){
            $err=true;
          }
          ...
          if($_POST['etat']=='En attente'){
            $message="Vous commande est enregistré et un mail de confirmation vous sera envoyé.";
          }elseif ($_POST['etat']=='confirme ') {
            $message="Votre commande peut etre prise en charge .";
          }else{
            $message="Votre commande vous attends au magasin";
          }

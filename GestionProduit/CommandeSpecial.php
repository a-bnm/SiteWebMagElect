 ...
 <body>
   <header>
    ...
    <div class="titre_page">
     <font size="6" color="white">Passer une commande </font>
    </div>
   ...
   <div class="main">
    ...
    ?>
        <div class="formulaire">
          <form method="post" action="CommandeSpecial.php">
            ...
            <textArea class="desc" name="description" >Autres informations</textArea>
    ...
    <?php
        ...
        $requete="insert into commandespecial (Email,identifiantCl,typeObj,marque,modele,description,etat,numero) values
                  ('".$mail."','".$_SESSION['id']."','".$type."','".$marque."','".$modele."','".$desc."','Envoye','".$tel."')";
